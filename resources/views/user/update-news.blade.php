                ...
                <div class="col-md-6">
                    <fieldset>
                        <div class="form-group">
                            ...
                            <input class="form-control" name="title" id="title" value="{{$news->title}}" type="text">
                        </div>
                        <div class="form-group">
                            <label class="label">Detail: </label>
                            <textarea name="detail" rows="14" cols="46" style="max-width:100%;" class="form-control">{{$news->detail}}</textarea>
                        </div>
                    ...
                    <fieldset>
                        <div class="form-group"><center>
                            <div id="image_preview">
                                <img id="previewing" src="{{url('assets/uploads')}}/{{$news->img}}" class="img img-responsive img-thumbnail">
                            </div></center>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    return Math.round(bytes / Math.pow(1024, i), 2) + ' ' + sizes[i];
        ...
        $("#").on('submit',(function(e) {
            ...
            $('#loading').show();
            $.ajax({
                url: "update-news",       // Url to which the request is send
